# Test: Resend Receiving Reference
...
```
[Test scaffold] For each scenario below, commit to a specific answer and write actual code — not pseudocode. Use the resend skill's receiving reference.
```
