...
Editing a published template creates a new draft — the published version keeps sending until you publish again. `has_unpublished_versions: true` in the get response indicates pending edits.
